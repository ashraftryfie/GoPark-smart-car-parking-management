...
cap = cv2.VideoCapture('camera/Car_Detection_Cam_2/test.mp4')
...
def checkSpace():
    ...
    if count < 9000:
        ...
        if isnew:
            ...
            # filename = 'camera/Car_Detection_Cam_2/carimage/savedImage.jpg'
                filename = 'AI/AI_models/YOLOv5/cars_outgoing/car.jpg'
